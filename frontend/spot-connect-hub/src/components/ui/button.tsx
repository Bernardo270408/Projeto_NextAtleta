  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-primary text-primary-foreground hover:shadow-glow hover:scale-[1.02]",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-lg hover:scale-[1.02]",
        premium: "gradient-premium text-premium-foreground hover:shadow-lg hover:scale-[1.02]",
        hero: "gradient-primary text-primary-foreground shadow-lg hover:shadow-glow hover:scale-[1.02]",
